...
const Journey = () => {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2  py-15 gap-20 md:ml-5 lg:ml-25 items-center">
    
    {/* Text Content */}
    <div className="flex items-center lg:items-start px-5 text-center lg:text-start flex-col">
      <h1 className='text-5xl text-[#ECECEC] font-semibold py-12'>Our Journey</h1>
